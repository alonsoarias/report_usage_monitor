...
<table border="1" style="border-collapse: collapse; width: 50%;">
    ...
    <tr>
        <td style="padding: 8px;">Assigned disk space</td>
        <td style="padding: 8px;"><strong>{$a->quotadisk}</strong></td>
    </tr>
    <tr>
        <td style="padding: 8px;">Disk space used</td>
        <td style="padding: 8px;"><strong>{$a->diskusage}</strong></td>
    </tr>
    <tr>
        <td style="padding: 8px;">Percentage of disk usage</td>
    ...
    <tr>
        <td style="padding: 8px;">Set threshold for maximum daily users</td>
        <td style="padding: 8px;"><strong>{$a->threshold} users</strong></td>
    </tr>
    <tr>
        <td style="padding: 8px;">Current number of users</td>
        <td style="padding: 8px;"><strong>{$a->numberofusers} users</strong></td>
    </tr>
    <tr>
        <td style="padding: 8px;">Percentage relative to the user threshold</td>
        <td style="padding: 8px;"><strong>{$a->userpercentage}%</strong></td>
    </tr>
</table>
<p>It is crucial to manage storage properly to avoid performance issues. Please access the <a href="{$a->referer}" target="_blank">system control panel</a> for more details.</p>
<hr>
