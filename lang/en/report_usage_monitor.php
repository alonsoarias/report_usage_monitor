...
$string['user_count_title'] = 'Daily User Count';
...
$string['active_users'] = 'Daily  Users';
...
<ul>
    ...
    <li>Users*: {$a->numberofusers} of {$a->threshold} ({$a->user_percent}%) - Level: {$a->user_alert}</li>
    <li>Date (DD/MM/YYYY): {$a->lastday}</li>
</ul>
...
<hr>
<i><p style="font-size: 0.9em; color: #666;">This message has been automatically generated by "Usage Report" from <a href="https://ingeweb.co/" target="_blank" ><strong>ingeweb.co</strong></a></p>
